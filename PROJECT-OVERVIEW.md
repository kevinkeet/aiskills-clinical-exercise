LEARN-AI (formerly Skill AI RCT) is a randomized controlled trial testing whether residents who work a clinical case with an AI assistant acquire knowledge they can apply without it. Residents at the Stanford internal medicine residency (PGY-1 through PGY-3, categorical and preliminary) are randomized one to one to work an identical clinical case with either an embedded AI chat assistant or UpToDate, and then complete the same knowledge assessment with no resource available. A second site, the Stanford Health Care Tri-Valley family medicine residency, is planned and will enroll once an IRB modification is approved. Target enrollment is 100 residents, 50 per arm. The study is approved as exempt under Stanford IRB-86737 and preregistered on the Open Science Framework; ClinicalTrials.gov registration is in process and must be completed before the first participant enrolls.

The study sits in a gap the current literature leaves open. Randomized trials of clinician AI assistance, including Goh and colleagues' diagnostic reasoning trial (JAMA Network Open, 2024), measure how well physicians perform while using the tool, and a 2026 meta-analysis of twenty randomized trials shows that AI built and deployed as a teaching tool improves knowledge. Neither answers whether clinicians learn from AI used incidentally during clinical work, which is how residents actually encounter it. The concern that they may not now has a name in medical education (de-skilling, never-skilling, and mis-skilling; Abdulnour et al., NEJM 2025; Ke et al., Nature Medicine 2026) and empirical support outside cognitive work: endoscopists' unassisted adenoma detection fell after routine AI-assisted colonoscopy (Budzyn et al., Lancet Gastroenterology and Hepatology 2025), and programmers who learned a new software library with AI assistance understood it less well, with the loss concentrated among those who delegated the work rather than engaged with it (Shen and Tamkin, 2026), the study that motivated this trial. For clinical knowledge the question is untested, and this trial is designed to test it.
